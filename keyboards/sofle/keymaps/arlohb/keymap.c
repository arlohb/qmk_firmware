 ...
 */
[_LOWER] = LAYOUT(
  TG(_NOHMR) , KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,                   KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 ,
...
[_GAMING] = LAYOUT(
  ...
  KC_LSFT    , _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______    ,
                        KC_Y   , KC_U   , _______, KC_SPC , KC_O   , _______, _______, _______, _______, _______
),

// No home row mods
[_NOHMR] = LAYOUT(
  TG(_NOHMR), _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, TG(_NOHMR) ,
  _______   , _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______    ,
  _______   , KC_A   , _______, KC_D   , KC_F   , _______,                   _______, KC_J   , KC_K   , _______, KC_SCLN, _______    ,
